...
### Track 0 — Prerequisites (START HERE if FastAPI/TF nahi aata)

| # | Path | Start when | Agent one-liner |
|---|------|------------|-----------------|
| 00a | [00a-dev-environment](./00a-dev-environment/MODULE.md) | Day 1 | "Docker Postgres Redis Python setup" |
| 00b | [00b-python-async](./00b-python-async/MODULE.md) | 00a done | "async await Pydantic — Zod Python mein" |
| 00c | [00c-fastapi](./00c-fastapi/MODULE.md) | 00b done | "FastAPI routes Depends middleware SSE" |
| 00d | [00d-ml-ai-foundations](./00d-ml-ai-foundations/MODULE.md) | 00b done | "ML basics embeddings TensorFlow intro" |
...
| 07 | [07-agents-langgraph](./07-agents-langgraph/MODULE.md) | 06 done | "LangGraph state machines" |
...
Canvas: [ai-learning-roadmap.canvas.tsx](/Users/vansh/.cursor/projects/Users-vansh-Desktop-Code-Learning-AI-AI-Development/canvases/ai-learning-roadmap.canvas.tsx)

Full plan: `@LEARNING-PLAN.md`
