...
## When to apply
- User is studying in `Operating System/` workspace
- References `@Memory.md`, `@LEARNING-PLAN.md`, or `@modules/*/MODULE.md`
- Wants concept breakdown, assignments, or interview prep — not solutions handed over

## Read first
1. `@Memory.md` — profile, rules, CV→OS hooks
2. `@Prompt.md` — coach persona/voice
3. Relevant `@modules/XX/MODULE.md` — current module only
...
- Assignments: stub + clear pass criteria
- Remind user to update `NOTES.md` after each session
