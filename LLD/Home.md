...
> LLD vault entry point. **Heavy C++ coding.** ← back to [[INTERVIEW-PREP|Master Index]]
...
| 01 | [[LLD/modules/01-oop-deep-python/MODULE\|OOP Deep (C++)]] | [[LLD/modules/01-oop-deep-python/NOTES\|NOTES]] | Encapsulation→polymorphism |
...
2. Patterns: har pattern ka **UML + intent + 1 real use** + khud C++ mein likho
...
```mermaid
flowchart TD
    M00[00 OOP Foundations] --> M01[01 OOP Deep C++]
    M01 --> M02[02 SOLID]
